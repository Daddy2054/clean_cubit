...
class _$_ToDoItem implements _ToDoItem {
  ...
  @override
  String toString() {
    return 'ToDoItem(id: $id, userId: $userId, title: $title, body: $body, note: $note, status: $status, updatedAt: $updatedAt, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, userId, title, body, note, status, updatedAt, createdAt);
...
abstract class _ToDoItem implements ToDoItem {
  const factory _ToDoItem(
      ...
      final bool status,
      final String updatedAt,
      final String createdAt}) = _$_ToDoItem;
